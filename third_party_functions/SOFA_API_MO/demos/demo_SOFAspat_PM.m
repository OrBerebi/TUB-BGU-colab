...
azi=[0 0];	% azimuth angles in degrees. If negative values are found, navigational system (-180;+180) will be used. 
ele=[-30 -30  0 90]; %elevation angles in degrees
